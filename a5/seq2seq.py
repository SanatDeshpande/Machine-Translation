...
def show_attention(input_sentence, output_words, attentions):
    ...
    # Set up axes
    ax.set_xlim(left=-0.5, right=len(input_sentence.split(' ')) + 0.5)
...
def main():
    ...
    ap.add_argument('--batch_size', default=16, type=int, help='size of batch')
    ...
    while iter_num < args.n_iters:
        ...
        for batch in range(args.batch_size):
            ...
            input_batch.append(training_pair[0])
            target_batch.append(training_pair[1])
